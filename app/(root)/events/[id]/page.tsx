          ...
          <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            <div className="flex flex-col text-white gap-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex gap-3">
                  ...
                  <p className="p-medium-16 rounded-full bg-grey-500/10 px-4 py-2.5">
                    {event.category.name}
                  </p>
                </div>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex gap-2 md:gap-3">
                ...
                <div className="w-72 p-medium-16 lg:p-regular-20 text-white flex flex-wrap items-center">
                  <p>
            ...
            <div className="flex flex-col gap-2 text-white">
              <p className="p-bold-20 text-grey-300">What You'll Learn:</p>
